...
@section('content')
    ...
    <div class="right_col" role="main">
        ...
        <div class="tile_count">
            ...
            <span class="count_top"><i class="fa fa-user"></i> Устройств</span>
            <div class="count">{{ $data['people_started'] }}</div>
                    ...
                    <div class="dashboard-widget-content">
                        ...
                        @foreach ( $data['messages'] as $v)
                            <li>
                                <div class="block">
                                <div class="block_content">
                                    <h2 class="title"><a>{{ $v['text'] }}</a></h2>
                                    <div class="byline">
                                    <span>{{ $v['created_at'] }}</span> by <a>{{ $v['from_id'] }}</a>
                                </div>
                            </li>
                        @endforeach
